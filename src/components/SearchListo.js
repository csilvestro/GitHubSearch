...
const SearchListo = (searchTerm) => {  
    // if (loading) {
    //     return(<p>Loading...</p>)
    // }
    return (
        <article style={styles.list} key={searchTerm.id}>
            <div>{searchTerm.name.first}fname</div>
            <div>{searchTerm.name.last}lname</div>
